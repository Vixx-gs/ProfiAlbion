...
interface CropDef {
  ...
  focusCost: number;
  focusBonus: number;
  /** Ciudades que dan bonificación de bioma (+10% rendimiento). */
  biomeCities: string[];
}

const CROPS: CropDef[] = [
  { id: 'CARROT', name: 'Zanahoria', iconId: 'T1_FARM_CARROT_SEED', harvestId: 'T1_CARROT', defaultSeedPrice: 2312, seedsPerHarvest: 0, yieldPerHarvest: 4.5, growHours: 22, focusCost: 0, focusBonus: 2.0, biomeCities: ['Lymhurst', 'Brecilien'] },
  { id: 'BEAN', name: 'Frijoles', iconId: 'T2_FARM_BEAN_SEED', harvestId: 'T2_BEAN', defaultSeedPrice: 3468, seedsPerHarvest: 0.3333, yieldPerHarvest: 4.5, growHours: 10, focusCost: 0, focusBonus: 1.33, biomeCities: ['Bridgewatch', 'Brecilien'] },
  { id: 'WHEAT', name: 'Trigo', iconId: 'T3_FARM_WHEAT_SEED', harvestId: 'T3_WHEAT', defaultSeedPrice: 5780, seedsPerHarvest: 0.6, yieldPerHarvest: 4.5, growHours: 14, focusCost: 0, focusBonus: 0.8, biomeCities: ['Martlock', 'Brecilien'] },
  { id: 'TURNIP', name: 'Rábano', iconId: 'T4_FARM_TURNIP_SEED', harvestId: 'T4_TURNIP', defaultSeedPrice: 8670, seedsPerHarvest: 0.7333, yieldPerHarvest: 4.5, growHours: 12, focusCost: 0, focusBonus: 0.53, biomeCities: ['Fort Sterling', 'Brecilien'] },
  { id: 'CABBAGE', name: 'Col', iconId: 'T5_FARM_CABBAGE_SEED', harvestId: 'T5_CABBAGE', defaultSeedPrice: 11560, seedsPerHarvest: 0.8, yieldPerHarvest: 4.5, growHours: 16, focusCost: 0, focusBonus: 0.4, biomeCities: ['Thetford', 'Brecilien'] },
  { id: 'POTATO', name: 'Patata', iconId: 'T6_FARM_POTATO_SEED', harvestId: 'T6_POTATO', defaultSeedPrice: 17340, seedsPerHarvest: 0.8667, yieldPerHarvest: 4.5, growHours: 18, focusCost: 0, focusBonus: 0.27, biomeCities: ['Martlock', 'Brecilien'] },
  { id: 'CORN', name: 'Maíz', iconId: 'T7_FARM_CORN_SEED', harvestId: 'T7_CORN', defaultSeedPrice: 26010, seedsPerHarvest: 0.9111, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.18, biomeCities: ['Bridgewatch', 'Brecilien'] },
  { id: 'PUMPKIN', name: 'Calabaza', iconId: 'T8_FARM_PUMPKIN_SEED', harvestId: 'T8_PUMPKIN', defaultSeedPrice: 34680, seedsPerHarvest: 0.9333, yieldPerHarvest: 4.5, growHours: 22, focusCost: 0, focusBonus: 0.13, biomeCities: ['Lymhurst', 'Brecilien'] },
];

const HERBS: CropDef[] = [
  { id: 'AGARIC', name: 'Agárico arcano', iconId: 'T2_FARM_AGARIC_SEED', harvestId: 'T2_AGARIC', defaultSeedPrice: 3468, seedsPerHarvest: 0.3333, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 1.33, biomeCities: ['Thetford'] },
  { id: 'COMFREY', name: 'Consuelda hojabrillante', iconId: 'T3_FARM_COMFREY_SEED', harvestId: 'T3_COMFREY', defaultSeedPrice: 5780, seedsPerHarvest: 0.6, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.8, biomeCities: ['Caerleon'] },
  { id: 'BURDOCK', name: 'Bardana almenada', iconId: 'T4_FARM_BURDOCK_SEED', harvestId: 'T4_BURDOCK', defaultSeedPrice: 8670, seedsPerHarvest: 0.7333, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.53, biomeCities: ['Lymhurst'] },
  { id: 'TEASEL', name: 'Cardo de dragón', iconId: 'T5_FARM_TEASEL_SEED', harvestId: 'T5_TEASEL', defaultSeedPrice: 11560, seedsPerHarvest: 0.8, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.4, biomeCities: ['Bridgewatch', 'Caerleon'] },
  { id: 'FOXGLOVE', name: 'Dedalera elusiva', iconId: 'T6_FARM_FOXGLOVE_SEED', harvestId: 'T6_FOXGLOVE', defaultSeedPrice: 17340, seedsPerHarvest: 0.8667, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.27, biomeCities: ['Martlock'] },
  { id: 'MULLEIN', name: 'Gordolobo ígneo', iconId: 'T7_FARM_MULLEIN_SEED', harvestId: 'T7_MULLEIN', defaultSeedPrice: 26010, seedsPerHarvest: 0.9111, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.18, biomeCities: ['Thetford', 'Caerleon'] },
  { id: 'YARROW', name: 'Milenrama demoníaca', iconId: 'T8_FARM_YARROW_SEED', harvestId: 'T8_YARROW', defaultSeedPrice: 34680, seedsPerHarvest: 0.9333, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.13, biomeCities: ['Fort Sterling'] },
];
...
@Component({
  ...
  imports: [DecimalPipe, LowerCasePipe, FormsModule, MarketHistory],
...
export class Farming {
  ...
  readonly biomeActive = computed(() => {
    ...
    return item.biomeCities.includes(this.plantCity());
  });
  ...
  constructor() {
    ...
    this.priceSub = this.fetchTrigger.pipe(
      ...
      if (!result || result.length === 0) {
        this.harvestPrices.set({});
        this.harvestDates.set({});
        this.yieldPrice.set(0);
        return;
      }
  ...
  readonly result = computed(() => {
    ...
    const biomeBonus = this.biomeActive() ? 1.1 : 1;
