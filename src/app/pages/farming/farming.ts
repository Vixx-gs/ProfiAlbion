...
const CROPS: CropDef[] = [
  ...
  { id: 'CABBAGE', name: 'Repollo', iconId: 'T5_FARM_CABBAGE_SEED', harvestId: 'T5_CABBAGE', defaultSeedPrice: 11560, seedsPerHarvest: 0.8, yieldPerHarvest: 4.5, growHours: 16, focusCost: 0, focusBonus: 0.4 },
...
const HERBS: CropDef[] = [
  ...
  { id: 'COMFREY', name: 'Consuelda Hoja Brillante', iconId: 'T3_FARM_COMFREY_SEED', harvestId: 'T3_COMFREY', defaultSeedPrice: 5780, seedsPerHarvest: 0.6, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.8 },
  { id: 'BURDOCK', name: 'Bardana Crenellada', iconId: 'T4_FARM_BURDOCK_SEED', harvestId: 'T4_BURDOCK', defaultSeedPrice: 8670, seedsPerHarvest: 0.7333, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.53 },
  ...
  { id: 'MULLEIN', name: 'Gordolobo de Fuego', iconId: 'T7_FARM_MULLEIN_SEED', harvestId: 'T7_MULLEIN', defaultSeedPrice: 26010, seedsPerHarvest: 0.9111, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.18 },
  { id: 'YARROW', name: 'Milenrama de Ghoul', iconId: 'T8_FARM_YARROW_SEED', harvestId: 'T8_YARROW', defaultSeedPrice: 34680, seedsPerHarvest: 0.9333, yieldPerHarvest: 4.5, growHours: 20, focusCost: 0, focusBonus: 0.13 },
];
